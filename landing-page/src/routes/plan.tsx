...
import { bookingIntro, makeWhatsAppUrl, whatsappUrl } from "../content";
...
function PlanPage() {
  ...
  return (
    <main>
      <section className="page-hero plan-hero"><p className="eyebrow">Plan & book</p><h1>Your journey starts with a conversation.</h1><p className="lead">Long Taa is approximately six hours from Miri by 4WD. Advance booking lets the community check accommodation, transport, guides and appropriate activities for your visit.</p><a className="primary-action dark-action" href={whatsappUrl} target="_blank" rel="noreferrer">Book on WhatsApp</a></section>
      <section className="content-section journey-facts"><div><p className="section-label">Getting here</p><h2>From Miri, into the Borneo interior.</h2><p>Destination: Long Taa, Dapui, Ulu Tinjar, Baram, Sarawak, Malaysia. The approximate six-hour 4WD journey from Miri is part of the experience.</p></div><dl className="facts"><div><dt>Starting point</dt><dd>Miri, Sarawak</dd></div><div><dt>4WD transfer</dt><dd>RM1,500 per vehicle, Miri–Long Taa–Miri. Maximum 3 guests.</dd></div><div><dt>Longboat + local guide + porter</dt><dd>RM600 per group. Maximum 3 guests per longboat.</dd></div><div><dt>Group size</dt><dd>No minimum guest number. Larger groups require additional vehicles and longboats, subject to availability.</dd></div></dl></section>
