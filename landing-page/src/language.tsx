...
const languageCopy = {
  en: {
    ...
    launch: "Ask Rumput",
    launchHint: "Need help?",
    guideKicker: "Meet Rumput · your local guide",
    rumputPronunciation: "Rumput · pronounced “room-poot”",
    guideTitle: "Let’s plan your journey",
    guideWelcome: "Hi, I’m Rumput. Tell me what kind of Long Taa experience you want, or let me prepare a complete trip brief for Clement.",
    rumputReady: "Ready to explore with you",
  ...
  ms: {
    ...
    launch: "Tanya Rumput",
    launchHint: "Perlu bantuan?",
    guideKicker: "Kenali Rumput · pemandu anda",
    rumputPronunciation: "Rumput · disebut “room-poot”",
    guideTitle: "Mari rancang perjalanan",
    guideWelcome: "Hai, saya Rumput. Ceritakan pengalaman Long Taa yang anda mahukan, atau biar saya sediakan ringkasan perjalanan lengkap untuk Clement.",
    rumputReady: "Bersedia meneroka bersama anda",
