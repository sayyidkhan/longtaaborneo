...
const languageCopy = {
  en: {
    ...
    guideWelcome: "Tell us what you are hoping to experience. We will help you shape the next step.",
    guideStart: "Choose a starting point",
    guidePlaceholder: "Ask about dates, travel or experiences",
    send: "Send",
    stop: "Stop",
    clear: "Clear chat",
  ...
  ms: {
    ...
    guideWelcome: "Ceritakan pengalaman yang anda harapkan. Kami akan bantu tentukan langkah seterusnya.",
    guideStart: "Pilih titik permulaan",
    guidePlaceholder: "Tanya tentang tarikh, perjalanan atau pengalaman",
    send: "Hantar",
    stop: "Berhenti",
